...
--
-- Table structure for table `MAP_KCD_SCT3`
--

DROP TABLE IF EXISTS `MAP_KCD_SCT3`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `MAP_KCD_SCT3` (
  `ORI_TP_CD` varchar(20) NOT NULL COMMENT '매핑도메인코드',
  ...
  KEY `index2` (`ORI_CD`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='검사 매핑 테이블';
