...
--
-- Table structure for table `MAP_KCD_SCT2`
--

DROP TABLE IF EXISTS `MAP_KCD_SCT2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `MAP_KCD_SCT2` (
  `ORI_TP_CD` varchar(20) NOT NULL DEFAULT 'MEDI' COMMENT '매핑도메인코드',
  ...
  PRIMARY KEY (`ORI_TP_CD`,`MAP_VER`,`ORI_CD`,`SCT_ID`,`SUB_ALT_KEY`),
  KEY `index2` (`ORI_CD`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='의약품 매핑 테이블';
